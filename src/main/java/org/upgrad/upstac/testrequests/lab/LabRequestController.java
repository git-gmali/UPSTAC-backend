...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
    	...
    	if (aUser.doesRoleIsTester()) {
    		log.info("LabRequestController:getForTester - The logged in user is a tester hence fetch the request list");
    		return testRequestQueryService.findByTester(aUser);
    	} else {
    		log.info("LabRequestController:getForTester - The logged in user is not a tester hence throwing exception of unauthorized access");
