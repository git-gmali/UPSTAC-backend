...
public class AppInitializationService implements ApplicationListener<ApplicationReadyEvent> {
  ...
  public void addDefaultUserData() {
    ...
    govtAuthority = userService
        .addGovernmentAuthority(createRegisterRequestWith("authority", getRandomPinCode()));
  ...
  private static String getRandomStreetName() {
    ...
    String street = getRandomItemInStrings(
        Arrays.asList("Gandhi Street", "Nehru Street", "Nietzche Avenue", "Jefferson Avenue",
            "Grant Avenue", "Franklin Avenue", "4th Street North", "8th Street", "Strawberry Lane",
            "Sycamore Street", "Monroe Drive", "Route 10", "Highland Avenue", "Sherman Street",
            "Mulberry Court", "Main Street North", "Hillside Drive", "Andover Court",
            "Eagle Street", "Lakeview Drive", "Mulberry Lane", "Route 6", "Lantern Lane",
            "5th Street", "Buttonwood Drive", "Colonial Avenue", "Ann Street", "Brookside Drive",
            "Canterbury Court", "Marshall Street", "Hudson Street", "Union Street", "Jones Street",
            "Sycamore Lane", "6th Avenue", "Clark Street", "Cedar Avenue", "Park Street",
            "Evergreen Lane", "Aspen Drive", "6th Street North", "Magnolia Avenue", "Heather Lane",
            "Spruce Avenue", "B Street", "Ashley Court", "York Street", "Front Street North",
            "Brook Lane", "Jackson Avenue", "Hillcrest Drive", "Windsor Drive", "2nd Street"));
